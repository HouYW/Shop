            ...
            <ul class="nav pull-right">
                <li id="fat-menu" class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a tabindex="-1" href="/index.php/Admin/Login/change">修改密码</a></li>
                        <li class="divider"></li>
                        <li><a tabindex="-1" href="/index.php/Admin/Login/login">安全退出</a></li>
                    </ul>
                </li>
            </ul>
...
<div class="content">
    ...
    <div class="well">
        ...
        <form action="" method="post" id="tab">
            ...
            <label>密码：</label>
            <input type="password" name="password" value="$<?php echo ($data["password"]); ?>" class="input-xlarge">
            <label>邮箱：</label>
